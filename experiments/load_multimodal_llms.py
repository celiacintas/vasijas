...
if __name__ == "__main__":
    ...
    prompt = """Classify this ceramic artifact into one culture: Iberian, Predynastic-egyptian, Kushite, Andean, East African, or West African. Respond with only the culture name."""
    rows = []
