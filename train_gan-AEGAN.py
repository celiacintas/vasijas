...
for epoch in tqdm.tqdm(range(epochs)):
    ...
    torch.save(model_G.state_dict(), 'models/generador_v1_current_{}.pkl'.format(epochs))
    torch.save(model_D.state_dict(), 'models/discriminador_v1_current_{}.pkl'.format(epochs))
...
torch.save(model_G.state_dict(), 'models/generador_v1_{}.pkl'.format(epochs))
torch.save(model_D.state_dict(), 'models/discriminador_v1_{}.pkl'.format(epochs))
